...
export type PerpInitialized = { market_id: string; symbol: string; contract_size: number; funding_interval_ms: number; initial_margin_bps: number; maintenance_margin_bps: number; liquidation_fee_bps: number; keeper_incentive_bps: number };
