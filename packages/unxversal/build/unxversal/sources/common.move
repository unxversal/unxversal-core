module unxversal::common {
    ...
    public fun calculate_fee_with_discount(
        ...
        if (payment_asset == b"UNXV".to_string() && unxv_balance >= (base_fee * discount_pct) / 100) {
    ...
    public struct FeeCalculation has drop {
        ...
        final_fee: u64,
        /// Asset used for payment (e.g., "UNXV" or collateral token)
        payment_asset: String,
    }
    ...
    public struct FeeCollected has copy, drop {
        ...
        amount: u64,
        /// Asset used to pay the fee (e.g., collateral token, "UNXV", or other)
        asset_type: String,
    ...
    /// Public constructor for FeeCollected event
    public fun new_fee_collected_event(
        fee_type: String,
        amount: u64,
        asset_type: String,
        user: address,
        ...
        FeeCollected {
            ...
            asset_type,
            user,
            unxv_discount_applied,
            timestamp,
        }
    }

    /// Emit a fee collected event (can only be called from this module)
    public fun emit_fee_collected_event(
        fee_type: String,
        amount: u64,
        asset_type: String,
        user: address,
